...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ Hello, HUNTER-XMD Legend! ✨*
...
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](https://github.com/ObedTech003/Hunter-xmd1)!  
╰─🛠️ *Prefix:* \`${prefix}\`
...
> _© MADE BY OBEDTECH_`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('254791637868', '25791637868', '254701082940');
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("HUNTER-XMD IS  STARTED ✅");
  });
